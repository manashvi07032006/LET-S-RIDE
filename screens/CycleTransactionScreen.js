...
export default class TransactionScreen extends React.Component {
  ...
  /* var cycleissue = db.collection("cycle")
   ...
   db.collection("students")
      ...
      .update({
        NoOfCyclesIssued: firebase.firestore.FieldValue.increment(1)
      });
  ...
  checkStudentEligibilityForCycleIssue = async () => {
    ...
    if (studentRef.docs.length == 0) {
      ...
      studentRef.docs.map(doc => {
        ...
        if (student.NoOfCyclesIssued < 2) {
          isStudentEligible = true;
        } else {
          isStudentEligible = false;
          Alert.alert("The student has already issued 2 cycles!");
            console.log("The student has already issued 2 cycles!");
          this.setState({
            scannedStudentId: "",
            scannedCycleId: ""
          });
    ...
    transactionRef.docs.map(doc => {
      ...
      if (lastCycleTransaction.studentId === this.state.scannedStudentId) {
        ...
        Alert.alert("The cycle wasn't issued by this student!");
          console.log("The cycle wasn't issued by this student!");
        this.setState({
          scannedStudentId: "",
          scannedCycleId: ""
        });
    ...
    if (!transactionType) {
      ...
      if (isStudentEligible) {
        ...
        Alert.alert("Cycle issued to the student!");
          console.log("Cycle issued to the student!");
      }
    } else {
